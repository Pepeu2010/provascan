...
export function buildCalibrationSheetHtml() {
  return `<main style="width:210mm;min-height:297mm;padding:20mm;font-family:Arial,sans-serif;color:#101828;background:#fff">
    ...
    <div style="width:100mm;height:100mm;border:1mm solid #101828;margin-top:12mm;display:grid;place-items:center;font-size:14pt;font-weight:700">100mm × 100mm</div>
...
export function buildPrintInstructionSheetHtml() {
  return `<main style="width:210mm;min-height:297mm;padding:22mm;font-family:Arial,sans-serif;color:#101828;background:#fff">
