...
const SUBJECT_DEFINITIONS = [
  ...
  { aliases: ["ingles", "lingua inglesa", "english"], key: "ingles", label: "Inglês" },
  { aliases: ["lingua portuguesa", "portugues", "lp"], key: "lingua-portuguesa", label: "Língua Portuguesa" },
  { aliases: ["matematica", "mat"], key: "matematica", label: "Matemática" },
