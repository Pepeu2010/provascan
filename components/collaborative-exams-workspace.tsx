...
export function CollaborativeExamsWorkspace() {
  ...
  const assignedTeacherIds = useMemo(() => new Set(sections.map((item) => item.teacherId).filter(Boolean)), [sections]);
