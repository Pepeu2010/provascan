...
const base = {
  ...
  imagemProcessada: "",
  prova: { alternativas: ["A", "B"], audienceId: "all", audienceLabel: "Geral", codigo: "EXAM-1", data: "2026-09-19", groupType: "GERAL" as const, id: "exam-1", quantidadeQuestoes: 2, status: "publicada" as const, templateVersion: "1", titulo: "Avaliação diagnóstica", yearSegment: "2" as const },
