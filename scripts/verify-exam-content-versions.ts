...
const restoreTransaction = readFileSync(new URL("../supabase/migrations/20260919200000_restore_exam_content_transaction.sql", import.meta.url), "utf8");
...
assert.match(restoreTransaction, /restore_teacher_exam_content_transaction/i);
assert.match(restoreTransaction, /delete from public\.answer_keys/i);
assert.match(restoreTransaction, /delete from public\.exam_questions/i);
assert.match(restoreTransaction, /insert into public\.exam_content_versions/i);
assert.match(restoreTransaction, /grant execute on function public\.restore_teacher_exam_content_transaction/i);
...
assert.match(service, /\.rpc\("restore_teacher_exam_content_transaction"/);
