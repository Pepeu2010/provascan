...
import { findStudentCandidates, findStudentCandidatesInText, sortCorrectionBatchesByRoster } from "../lib/student-matching";
...
assert.deepEqual(sortCorrectionBatchesByRoster([{ studentId: "2" }, { studentId: "3" }, {}], students).map((item) => item.studentId ?? "none"), ["3", "2", "none"]);
