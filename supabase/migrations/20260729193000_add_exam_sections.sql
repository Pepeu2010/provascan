-- A prova integrada mantém os blocos que aparecem no cartão-resposta:
-- disciplina, ordem e quantidade de questões. O JSONB preserva a ordem sem
-- transformar uma prova de 45 questões em registros de provas independentes.
